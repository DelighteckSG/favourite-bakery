...
const resources = [
  ...
  {
    name: "Privacy Policy",
    description: "Privacy Policy description here",
    href: "#",
    icon: BookmarkSquareIcon,
  },
  {
    name: "Events",
    description: "Look for best Events to our new Product Tasting for free.",
    href: "#",
    icon: CalendarIcon,
  },
];
const recentPosts = [
  { id: 1, name: "How to choose your healthy bakery product", href: "#" },
  {
    id: 2,
    name: "What you can buy from us on cheat day?",
    href: "#",
  },
];
      ...
      <div class="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-md">
          <strong class="block text-center text-xl font-medium text-gray-900 dark:text-white sm:text-3xl">
            Subscribe here get upto 50% off on first purchase online
          </strong>
          ...
          <form class="mt-6">
            <div class="relative max-w-lg">
              ...
              <input
                class="w-full rounded-full border-gray-200 bg-gray-100 p-4 pr-32 text-sm font-medium dark:border-gray-700 dark:bg-gray-800 dark:text-white"
                id="email"
                type="email"
