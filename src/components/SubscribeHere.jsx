      ...
      {buttonState !== "SUCCESS" && (
        <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
          ...
          >
            ...
            <strong className="mt-10 block text-center text-xl font-medium text-gray-900 dark:text-white sm:text-3xl">
            ...
            <div className="mt-6 flex">
              ...
              <button
                type="submit"
                className="min-w-0 flex-auto appearance-none rounded-md border bg-blue-600 text-white dark:text-blue-800 border-zinc-900/10 dark:bg-white px-3 py-[calc(theme(spacing.2)-1px)] shadow-md shadow-zinc-800/5 placeholder:text-zinc-400 focus:border-blue-500 focus:outline-none focus:ring-4 focus:ring-blue-500/10 dark:border-zinc-700 dark:bg-zinc-700/[0.15] dark:text-zinc-200 dark:placeholder:text-zinc-500 dark:focus:border-blue-400 dark:focus:ring-blue-400/10 sm:text-sm"
              >
                Subscribe Now
              </button>
            </div>
