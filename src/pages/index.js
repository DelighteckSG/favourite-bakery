...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="h-half w-full bg-[conic-gradient(at_right,_var(--tw-gradient-stops))] from-gray-100 via-violet-400 to-red-200">
        <div className="relative px-6 lg:px-8">
          <div className="mx-auto max-w-2xl py-16 sm:py-48 lg:py-36">
            <div className="hidden sm:mb-8 sm:flex sm:justify-center">
              <div className="relative rounded-full py-1 px-3 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                ...
                <Link href="/cakes" className="font-semibold text-indigo-600">
          ...
          <div className="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]">
            <svg
              className="relative left-[calc(50%+3rem)] h-[11.1875rem] max-w-none -translate-x-1/2 sm:left-[calc(50%+36rem)] sm:h-[22.375rem]"
